        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          >
            ...
            <div className=" relative w-full ">
              <img src={NonTech} alt=""  className='w-full h-[400px]'/>
              <div className="mb-6">
                <span className="absolute top-10 left-10 px-3 py-1 text-xs font-semibold bg-blue-500 text-white-500 rounded-full">
                  Clinical Platform
                </span>
              </div>
            </div>
            ...
            <div className="p-8 md:p-10">
              ...
              <div className="mb-8">
               ...
               <Heart/>
                  ...
                  <h3 className="text-2xl font-bold">Health360</h3>
                </div>
  ...
  >
    Live Demo
          ...
          >
            {/* Visual Illustration - Top */}
            <div className="relative w-full">
                <img src={Clincal} alt="" className='w-full h-[400px]'/>
                    <div className="mb-6">
                <span className="absolute top-10 left-10 px-3 py-1 text-xs font-semibold bg-purple-500 text-white-500 rounded-full">
            ...
            <div className="p-8 md:p-10">
              ...
              <div className="mb-8">
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-2xl font-bold">DIGINexa</h3>
                </div>
