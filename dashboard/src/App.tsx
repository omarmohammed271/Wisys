...
function App() {
  ...
  return (
    <ThemeProvider defaultTheme="dark" storageKey="vite-ui-theme">
      <Router>
        <main className='bg-background select-none text-foreground lg:h-screen lg:overflow-hidden flex flex-col py-3 md:px-20'>
          <NavBar />
          <div className='flex flex-col flex-1'>
            <Routes>
              <Route path="/" element={<Home />} />
              <Route path="/healthcare" element={<Healthcare />} />
              <Route path="/non-healthcare" element={<NonHealthcare />} />
